...
/*  
    ...
    8: 64 pages
        Micro
*/
const BGCOLOR = '#e8bede'; // Change this hex value to set the background color. Remember to keep the quotes!
const ALT = 'How to Kind Ride Placeholder Zine'; // Change this to a plaintext copy or description of your content to make it visible to screen-readers
